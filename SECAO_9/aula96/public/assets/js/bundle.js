...
var gerarSenha = document.querySelector('.gerar-senha'); // Aqui exportamos essa função anônima para o nosso arquivo JS principal.
...
function gera() {
  var senha = (0,_geradores__WEBPACK_IMPORTED_MODULE_0__.default)(qtdCaracteres.value, // valor do número que se encontra no input '.qtd-caracteres'.
...
var simbolos = ',.;~^[]{}!@#$%*()_+=-'; // Aqui vamos selecionar um símbolo aleatório da nossa string (simbolos na posição aleatória gerada por rand, de 0 até o tamanho da string 'simbolos').
...
function geraSenha(qtd, maiusculas, minusculas, numeros, simbolos) {
  var senhaArray = [];
  qtd = Number(qtd); // Abaixo está ocorrendo uma avaliação de curto circuito. Se os parâmetros forem avaliados como TRUE, automaticamente o "arraySenha" vai receber uma string aleatória de acordo com cada parâmetro.
...
/* harmony import */ var _assets_css_style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./assets/css/style.css */ "./src/assets/css/style.css");
 ...
 // A função anônima que foi exportada como DEFAULT está assumindo o nome do próprio arquivo (formGeraSenha) e está sendo executada aqui abaixo.
